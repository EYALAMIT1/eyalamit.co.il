...
מסמך זה מרכז את ההמלצות להקמת סביבת עבודה מקומית עבור תיקיית **`eyalamit.co.il-legacy`** (מאגר `EYALAMIT1/eyalamit.co.il`), תוך שמירה על משאבים נמוכים במחשב העבודה הראשי.  
