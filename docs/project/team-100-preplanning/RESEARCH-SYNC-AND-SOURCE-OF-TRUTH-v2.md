...
| רמה | מקור | משמעות |
|-----|------|--------|
| **1** | **החלטות אייל** (שיחות מאושרות, [`EYAL-EXECUTIVE-SUMMARY-FOR-APPROVAL.md`](./EYAL-EXECUTIVE-SUMMARY-FOR-APPROVAL.md) לאחר חתימה) | **גובר תמיד** — המדויק והמעודכן ביותר לעומת סריקה ראשונית. |
