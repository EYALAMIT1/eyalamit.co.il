...
class Envira_Social_Shortcode {
    ...
    */
    public function metadata() {
        ...
        if ( $this->get_config( 'social_facebook_show_option_optional_text', $data ) && $this->get_config( 'social_facebook_text', $data ) ) {
          if ( trim($social_description) != '' ) {
            $social_description .= ' | ';
          }
          $social_description .= esc_textarea( $this->get_config( 'social_facebook_text', $data ) );
        }
...
<meta name="twitter:image" content="<?php echo $item['src']; ?>" />
  ...
  */
    public function gallery_output_css_js( $data ) {
        ...
        if ( ! $this->get_config( 'social', $data ) && ! $this->get_config( 'social_lightbox', $data ) && ! $this->get_config( 'mobile_social', $data ) && ! $this->get_config( 'mobile_social_lightbox', $data ) ) {
            return;
        }
