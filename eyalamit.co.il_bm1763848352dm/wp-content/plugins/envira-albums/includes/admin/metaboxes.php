...
class Envira_Albums_Metaboxes {
    ...
    */
                        ...
                        <th scope="row">
                            ...
                            <td>
                                <select id="envira-config-album-back-location" name="_eg_album_data[config][back_location]">
                                    <?php foreach ( (array) $this->back_to_album_locations() as $i => $data ) : ?>
                                        <option value="<?php echo $data['value']; ?>"<?php selected( $data['value'], $this->get_config( 'back_location', $this->get_config_default( 'back_location' ) ) ); ?>><?php echo $data['name']; ?></option>
                                    <?php endforeach; ?>
                                </select>
    ...
    /**
     * Helper method for retrieving back to album locations.
     *
     * @since 1.4.6
     *
     * @return array Array of thumbnail position data.
     */
    public function back_to_album_locations() {

        $instance = Envira_Albums_Common_Admin::get_instance();
        return $instance->back_to_album_locations();
