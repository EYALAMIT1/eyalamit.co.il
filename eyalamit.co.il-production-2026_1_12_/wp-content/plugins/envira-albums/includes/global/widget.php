    ...
    public function widget_get_albums() {
        ...
        if ( is_array( $albums ) ) {
            foreach ( $albums as $album ) {
                ...
                $albums_post = get_post( $albums['id'] );
                ...
                if ( is_array( $albums ) ) {
                    foreach ( $albums as $album ) {
                        if ( $album_id && $album['id'] == $album_id ) { 
                            echo '<option selected="selected" value="' . absint( $album['id'] ) . '">' . $album['config']['title'] . '</option>'; 
                        } else {
                            echo '<option value="' . absint( $album['id'] ) . '">' . $album['config']['title'] . '</option>'; 
                        }
                    }
                }
