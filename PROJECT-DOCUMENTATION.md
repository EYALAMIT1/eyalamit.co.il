...
## ⚠️ **מסמכי חובה - קריאה לפני תחילת עבודה**

**לפני תחילת כל עבודה בפרויקט, חובה לקרוא את:**

### 🗺️ **מפת דרכים 2026** (ראשון!)
📋 **[מפת דרכים - אופטימיזציה 2026](docs/project/ROADMAP-2026.md)**
*מסמך זה מספק את הקונטקסט הכללי והבנה של הפרויקט. חובה לכל צוות חדש!*

### 📋 **נהלי עבודה וגבולות גזרה**
...
**⚠️ שני המסמכים הללו הם תנאי מקדים לתחילת עבודה!**
...
### תיעוד - חובה
- 🗺️ **`docs/project/ROADMAP-2026.md`** - **מפת דרכים - אופטימיזציה 2026 - חובה לקריאה לכל צוות חדש!**
