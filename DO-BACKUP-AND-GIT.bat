...
if %ERRORLEVEL% EQU 0 (
    ...
    pwsh.exe -NoProfile -ExecutionPolicy Bypass -File ".\scripts\simple-backup-and-git.ps1"
) else (
    echo [INFO] PowerShell 7 לא נמצא, משתמש ב-PowerShell רגיל...
    powershell.exe -NoProfile -ExecutionPolicy Bypass -File ".\scripts\simple-backup-and-git.ps1"
)
